...
export default function Avatars() {
  return (
    <>
      <PageMeta
        title="React.js Avatars Dashboard | Inversiones Maescar - React.js Admin Dashboard Template"
        description="This is React.js Avatars Dashboard page for Inversiones Maescar - React.js Tailwind CSS Admin Dashboard Template"
      />
