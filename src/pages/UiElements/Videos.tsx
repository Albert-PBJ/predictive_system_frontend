...
export default function Videos() {
  return (
    <>
      <PageMeta
        title="React.js Videos Tabs | Inversiones Maescar - React.js Admin Dashboard Template"
        description="This is React.js Videos page for Inversiones Maescar - React.js Tailwind CSS Admin Dashboard Template"
      />
