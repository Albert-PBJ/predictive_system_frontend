...
export default function Badges() {
  return (
    <div>
      <PageMeta
        title="React.js Badges Dashboard | Inversiones Maescar - React.js Admin Dashboard Template"
        description="This is React.js Badges Dashboard page for Inversiones Maescar - React.js Tailwind CSS Admin Dashboard Template"
      />
