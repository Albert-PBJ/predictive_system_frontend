    ...
    <div className="relative">
      ...
      >
        <div>
          ...
          {user?.role_display && (
            <span className="mt-1 inline-block rounded-full bg-brand-50 px-2 py-0.5 text-theme-xs font-medium text-brand-600 dark:bg-brand-500/15 dark:text-brand-400">
              {user.role_display}
            </span>
          )}
        </div>
