...
const HINTS: Record<string, string> = {
  ...
  shock_cambiario:
    "Devaluación del dólar paralelo por encima de su ritmo reciente: capta las caídas de demanda por saltos cambiarios bruscos.",
  rate_shock:
    "Devaluación del dólar paralelo por encima de su ritmo reciente, en el mes en que se emitió el presupuesto.",
